...
public class Genral extends AppCompatActivity {
   ...
   public static int out = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_genral);
        ...
        incr = i;
        try {
            bf[bfin] = new BufferedReader(new FileReader(Environment.getExternalStorageDirectory()+"//quiz//genral//"+i.toString()+".log"));
    ...
    public  void  action(View v)
    {
        ...
        if (chk<10) {
            try {
                bf[bfin] = new BufferedReader(new FileReader(Environment.getExternalStorageDirectory()+"//quiz//genral//"+incr.toString()+".log"));
                ques = bf[bfin].readLine();
                a = bf[bfin].readLine();
                b = bf[bfin].readLine();
                c = bf[bfin].readLine();
