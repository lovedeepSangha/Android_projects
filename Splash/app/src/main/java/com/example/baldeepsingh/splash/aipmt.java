...
public class aipmt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aipmt);
        ...
        incr = i;
        try {
            bf[bfin] = new BufferedReader(new FileReader(Environment.getExternalStorageDirectory()+"//quiz//aipmt//"+i.toString()+".log"));
    ...
    public  void  action(View v)
    {
        ...
        if (chk<10) {
            try {
                bf[bfin] = new BufferedReader(new FileReader(Environment.getExternalStorageDirectory()+"//quiz//aipmt//"+incr.toString()+".log"));
                ques = bf[bfin].readLine();
                a = bf[bfin].readLine();
                b = bf[bfin].readLine();
                c = bf[bfin].readLine();
