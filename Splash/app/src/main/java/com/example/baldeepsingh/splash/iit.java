...
public class iit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        incr = i;
        try {
            bf[bfin] = new BufferedReader(new FileReader(Environment.getExternalStorageDirectory()+"//quiz//iit//"+i.toString()+".log"));
    ...
    public  void  action(View v)
    {
        ...
        if (chk<10) {
            try {
                bf[bfin] = new BufferedReader(new FileReader(Environment.getExternalStorageDirectory()+"//quiz//iit//"+incr.toString()+".log"));
                ques = bf[bfin].readLine();
                a = bf[bfin].readLine();
                b = bf[bfin].readLine();
                c = bf[bfin].readLine();
